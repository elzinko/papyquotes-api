...
var quotes = [
    ...
    { quote: "Avec la solitude comme seul apôtre,\nPuisque paraît-il, l'enfer c'est les autres" },
    { quote: "J’ai joué ton cœur à pile ou face, la pièce est tombée sur le côté" },
    { quote: "Oublier de bar en bar, arborer un sourire et boire du 'sky.\nMontrer ses dents aux pauvres glands pour combattre le mal par l'émail" },
    ...
    { quote: "J'arrive en mode Rambo, ma mitraillette fait clic-clic.\nPour vous, bande de tapettes, j'vais ramener toute ma clique-clique" },
    ...
    { quote: "C'est pas que je sois particulièrement inquiet pour ma santé,\nJe veux juste pas finir légume alors qu'on me force à en manger" },
    ...
    { quote: "J'suis trop bien pour vous,\nJ'vous regarderais de haut si seulement je tenais debout" }
];